...
pub mod gtk_primary_selection_device_manager {
  ...
  impl GtkPrimarySelectionDeviceManager {
    #[doc = "create a new primary selection source\n\nCreate a new primary selection source."]
    pub fn create_source(&self) -> Main<super::gtk_primary_selection_source::GtkPrimarySelectionSource> {
  ...
  static mut gtk_primary_selection_device_manager_requests_create_source_types: [*const wl_interface; 1] =
    [unsafe { &super::gtk_primary_selection_source::gtk_primary_selection_source_interface as *const wl_interface }];
  static mut gtk_primary_selection_device_manager_requests_get_device_types: [*const wl_interface; 2] = [
    unsafe { &super::gtk_primary_selection_device::gtk_primary_selection_device_interface as *const wl_interface },
  ...
  pub static mut gtk_primary_selection_device_manager_requests: [wl_message; 3] = [
    wl_message {
      ...
      types: unsafe { &gtk_primary_selection_device_manager_requests_create_source_types as *const _ },
    },
    wl_message {
      name: b"get_device\0" as *const u8 as *const c_char,
      signature: b"no\0" as *const u8 as *const c_char,
      types: unsafe { &gtk_primary_selection_device_manager_requests_get_device_types as *const _ },
    },
    wl_message {
...
pub mod gtk_primary_selection_device {
    ...
    unsafe fn from_raw_c(obj: *mut ::std::os::raw::c_void, opcode: u32, args: *const wl_argument) -> Result<Event, ()> {
      match opcode {
        0 => {
          ...
          Ok(Event::DataOffer {
            offer: Main::<super::gtk_primary_selection_offer::GtkPrimarySelectionOffer>::from_c_ptr(
              _args[0].o as *mut _,
            ),
          })
        }
        1 => {
          ...
          Ok(Event::Selection {
            id: if _args[0].o.is_null() {
              ...
              Some(
                Proxy::<super::gtk_primary_selection_offer::GtkPrimarySelectionOffer>::from_c_ptr(_args[0].o as *mut _)
                  .into(),
              )
            },
          })
  ...
  pub static mut gtk_primary_selection_device_requests: [wl_message; 2] = [
    wl_message {
      ...
      types: unsafe { &gtk_primary_selection_device_requests_set_selection_types as *const _ },
    },
    wl_message {
      name: b"destroy\0" as *const u8 as *const c_char,
      signature: b"\0" as *const u8 as *const c_char,
  ...
  static mut gtk_primary_selection_device_events_data_offer_types: [*const wl_interface; 1] =
    [unsafe { &super::gtk_primary_selection_offer::gtk_primary_selection_offer_interface as *const wl_interface }];
