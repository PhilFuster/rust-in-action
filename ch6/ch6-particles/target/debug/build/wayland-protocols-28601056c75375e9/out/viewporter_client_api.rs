...
pub mod wp_viewporter {
  ...
  pub enum Request {
    ...
    GetViewport { surface: super::wl_surface::WlSurface },
  }
  ...
  impl WpViewporter {
    ...
    #[doc = "extend surface interface for crop and scale\n\nInstantiate an interface extension for the given wl_surface to\ncrop and scale its content. If the given wl_surface already has\na wp_viewport object associated, the viewport_exists\nprotocol error is raised."]
    pub fn get_viewport(&self, surface: &super::wl_surface::WlSurface) -> Main<super::wp_viewport::WpViewport> {
  ...
  impl super::MessageGroup for Request {
    ...
    fn into_raw(self, sender_id: u32) -> Message {
      match self {
        ...
        Request::SetSource { x, y, width, height } => Message {
          sender_id: sender_id,
          opcode: 1,
          args: smallvec![
