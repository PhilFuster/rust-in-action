...
pub mod zwlr_output_power_manager_v1 {
  ...
  impl super::MessageGroup for Request {
    ...
    fn child<Meta: ObjectMetadata>(opcode: u16, version: u32, meta: &Meta) -> Option<Object<Meta>> {
      match opcode {
        0 => Some(Object::from_interface::<super::zwlr_output_power_v1::ZwlrOutputPowerV1>(version, meta.child())),
        _ => None,
      }
    }
  ...
  impl ZwlrOutputPowerManagerV1 {
    ...
    pub fn get_output_power(
      ...
      let msg = Request::GetOutputPower { output: output.clone() };
  ...
  static mut zwlr_output_power_manager_v1_requests_get_output_power_types: [*const wl_interface; 2] = [
    unsafe { &super::zwlr_output_power_v1::zwlr_output_power_v1_interface as *const wl_interface },
  ...
  pub static mut zwlr_output_power_manager_v1_requests: [wl_message; 2] = [
    wl_message {
      ...
      types: unsafe { &zwlr_output_power_manager_v1_requests_get_output_power_types as *const _ },
    },
    wl_message {
