...
pub mod zxdg_decoration_manager_v1 {
  ...
  pub enum Request {
    ...
    GetToplevelDecoration { toplevel: super::xdg_toplevel::XdgToplevel },
  }
  ...
  static mut zxdg_decoration_manager_v1_requests_get_toplevel_decoration_types: [*const wl_interface; 2] = [
    unsafe { &super::zxdg_toplevel_decoration_v1::zxdg_toplevel_decoration_v1_interface as *const wl_interface },
  ...
  pub static mut zxdg_decoration_manager_v1_requests: [wl_message; 2] = [
    ...
    wl_message {
      ...
      types: unsafe { &zxdg_decoration_manager_v1_requests_get_toplevel_decoration_types as *const _ },
    },
  ];
