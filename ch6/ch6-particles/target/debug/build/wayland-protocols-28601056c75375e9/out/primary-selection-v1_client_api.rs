...
pub mod zwp_primary_selection_device_manager_v1 {
  ...
  impl ZwpPrimarySelectionDeviceManagerV1 {
    #[doc = "create a new primary selection source\n\nCreate a new primary selection source."]
    pub fn create_source(&self) -> Main<super::zwp_primary_selection_source_v1::ZwpPrimarySelectionSourceV1> {
  ...
  static mut zwp_primary_selection_device_manager_v1_requests_create_source_types: [*const wl_interface; 1] =
    [unsafe {
      &super::zwp_primary_selection_source_v1::zwp_primary_selection_source_v1_interface as *const wl_interface
    }];
  static mut zwp_primary_selection_device_manager_v1_requests_get_device_types: [*const wl_interface; 2] = [
    unsafe {
      &super::zwp_primary_selection_device_v1::zwp_primary_selection_device_v1_interface as *const wl_interface
    },
  ...
  pub static mut zwp_primary_selection_device_manager_v1_requests: [wl_message; 3] = [
    wl_message {
      ...
      types: unsafe { &zwp_primary_selection_device_manager_v1_requests_create_source_types as *const _ },
    },
    wl_message {
      name: b"get_device\0" as *const u8 as *const c_char,
      signature: b"no\0" as *const u8 as *const c_char,
      types: unsafe { &zwp_primary_selection_device_manager_v1_requests_get_device_types as *const _ },
    },
    wl_message {
...
pub mod zwp_primary_selection_device_v1 {
    ...
    unsafe fn from_raw_c(obj: *mut ::std::os::raw::c_void, opcode: u32, args: *const wl_argument) -> Result<Event, ()> {
      match opcode {
        0 => {
          ...
          Ok(Event::DataOffer {
            offer: Main::<super::zwp_primary_selection_offer_v1::ZwpPrimarySelectionOfferV1>::from_c_ptr(
              _args[0].o as *mut _,
            ),
          })
        }
        1 => {
          ...
          Ok(Event::Selection {
            id: if _args[0].o.is_null() {
              ...
              Some(
                Proxy::<super::zwp_primary_selection_offer_v1::ZwpPrimarySelectionOfferV1>::from_c_ptr(
                  _args[0].o as *mut _,
                )
                .into(),
              )
  ...
  static mut zwp_primary_selection_device_v1_events_data_offer_types: [*const wl_interface; 1] = [unsafe {
    &super::zwp_primary_selection_offer_v1::zwp_primary_selection_offer_v1_interface as *const wl_interface
  }];
  static mut zwp_primary_selection_device_v1_events_selection_types: [*const wl_interface; 1] = [unsafe {
    &super::zwp_primary_selection_offer_v1::zwp_primary_selection_offer_v1_interface as *const wl_interface
  }];
  #[doc = r" C-representation of the messages of this interface, for interop"]
