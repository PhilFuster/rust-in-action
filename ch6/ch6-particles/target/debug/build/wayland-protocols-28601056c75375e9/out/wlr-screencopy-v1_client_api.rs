...
pub mod zwlr_screencopy_manager_v1 {
  ...
  impl super::MessageGroup for Request {
    ...
    fn into_raw(self, sender_id: u32) -> Message {
      match self {
        Request::CaptureOutput { overlay_cursor, output } => Message {
          sender_id: sender_id,
          opcode: 0,
          args: smallvec![
            Argument::NewId(0),
    ...
    {
      match self {
        Request::CaptureOutput { overlay_cursor, output } => {
  ...
  static mut zwlr_screencopy_manager_v1_requests_capture_output_types: [*const wl_interface; 3] = [
    unsafe { &super::zwlr_screencopy_frame_v1::zwlr_screencopy_frame_v1_interface as *const wl_interface },
  ...
  pub static mut zwlr_screencopy_manager_v1_requests: [wl_message; 3] = [
    ...
    wl_message {
      ...
      types: unsafe { &zwlr_screencopy_manager_v1_requests_capture_output_region_types as *const _ },
    },
    wl_message {
...
pub mod zwlr_screencopy_frame_v1 {
          ...
          Ok(Event::Buffer {
            format: {
              if let Some(Argument::Uint(val)) = args.next() {
                super::wl_shm::Format::from_raw(val).ok_or(())?
              } else {
                return Err(());
              }
            },
    ...
    unsafe fn from_raw_c(obj: *mut ::std::os::raw::c_void, opcode: u32, args: *const wl_argument) -> Result<Event, ()> {
      match opcode {
        0 => {
          ...
          Ok(Event::Buffer {
            format: super::wl_shm::Format::from_raw(_args[0].u).ok_or(())?,
            width: _args[1].u,
            height: _args[2].u,
            stride: _args[3].u,
          })
  ...
  impl ZwlrScreencopyFrameV1 {
    ...
    pub fn copy(&self, buffer: &super::wl_buffer::WlBuffer) -> () {
      let msg = Request::Copy { buffer: buffer.clone() };
      self.0.send::<AnonymousObject>(msg, None);
    }
    #[doc = "delete this object, used or not\n\nDestroys the frame. This request can be sent at any time by the client.\n\nThis is a destructor, you cannot send requests to this object any longer once this method is called."]
    pub fn destroy(&self) -> () {
    ...
    pub fn copy_with_damage(&self, buffer: &super::wl_buffer::WlBuffer) -> () {
      let msg = Request::CopyWithDamage { buffer: buffer.clone() };
      self.0.send::<AnonymousObject>(msg, None);
    }
  }
  #[doc = r" The minimal object version supporting this request"]
