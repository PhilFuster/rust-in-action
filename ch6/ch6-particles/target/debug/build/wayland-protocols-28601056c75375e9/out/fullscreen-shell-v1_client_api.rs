...
pub mod zwp_fullscreen_shell_v1 {
    ...
    unsafe fn from_raw_c(obj: *mut ::std::os::raw::c_void, opcode: u32, args: *const wl_argument) -> Result<Event, ()> {
      match opcode {
        0 => {
          ...
          Ok(Event::Capability { capability: _args[0].u })
        }
        _ => return Err(()),
      }
    }
  ...
  static mut zwp_fullscreen_shell_v1_requests_present_surface_for_mode_types: [*const wl_interface; 4] = [
    unsafe { &super::wl_surface::wl_surface_interface as *const wl_interface },
    unsafe { &super::wl_output::wl_output_interface as *const wl_interface },
    NULLPTR as *const wl_interface,
    unsafe {
      &super::zwp_fullscreen_shell_mode_feedback_v1::zwp_fullscreen_shell_mode_feedback_v1_interface
  ...
  pub static mut zwp_fullscreen_shell_v1_requests: [wl_message; 3] = [
    ...
    wl_message {
      ...
      types: unsafe { &zwp_fullscreen_shell_v1_requests_present_surface_for_mode_types as *const _ },
    },
  ];
  #[doc = r" C-representation of the messages of this interface, for interop"]
