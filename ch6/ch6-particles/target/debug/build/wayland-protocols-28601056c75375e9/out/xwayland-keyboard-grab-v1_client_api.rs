...
pub mod zwp_xwayland_keyboard_grab_manager_v1 {
  ...
  static mut zwp_xwayland_keyboard_grab_manager_v1_requests_grab_keyboard_types: [*const wl_interface; 3] = [
    unsafe { &super::zwp_xwayland_keyboard_grab_v1::zwp_xwayland_keyboard_grab_v1_interface as *const wl_interface },
  ...
  pub static mut zwp_xwayland_keyboard_grab_manager_v1_requests: [wl_message; 2] = [
    ...
    wl_message {
      ...
      types: unsafe { &zwp_xwayland_keyboard_grab_manager_v1_requests_grab_keyboard_types as *const _ },
    },
  ];
