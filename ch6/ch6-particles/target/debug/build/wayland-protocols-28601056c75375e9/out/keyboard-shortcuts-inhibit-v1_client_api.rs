...
pub mod zwp_keyboard_shortcuts_inhibit_manager_v1 {
  ...
  static mut zwp_keyboard_shortcuts_inhibit_manager_v1_requests_inhibit_shortcuts_types: [*const wl_interface; 3] = [
    unsafe {
  ...
  pub static mut zwp_keyboard_shortcuts_inhibit_manager_v1_requests: [wl_message; 2] = [
    ...
    wl_message {
      ...
      types: unsafe { &zwp_keyboard_shortcuts_inhibit_manager_v1_requests_inhibit_shortcuts_types as *const _ },
    },
  ];
