...
pub mod zwlr_data_control_manager_v1 {
  ...
  impl ZwlrDataControlManagerV1 {
    #[doc = "create a new data source\n\nCreate a new data source."]
    pub fn create_data_source(&self) -> Main<super::zwlr_data_control_source_v1::ZwlrDataControlSourceV1> {
  ...
  static mut zwlr_data_control_manager_v1_requests_create_data_source_types: [*const wl_interface; 1] =
    [unsafe { &super::zwlr_data_control_source_v1::zwlr_data_control_source_v1_interface as *const wl_interface }];
  static mut zwlr_data_control_manager_v1_requests_get_data_device_types: [*const wl_interface; 2] = [
    unsafe { &super::zwlr_data_control_device_v1::zwlr_data_control_device_v1_interface as *const wl_interface },
  ...
  pub static mut zwlr_data_control_manager_v1_requests: [wl_message; 3] = [
    wl_message {
      ...
      types: unsafe { &zwlr_data_control_manager_v1_requests_create_data_source_types as *const _ },
    },
    wl_message {
...
pub mod zwlr_data_control_device_v1 {
    ...
    fn into_raw(self, sender_id: u32) -> Message {
      match self {
        Request::SetSelection { source } => Message {
          sender_id: sender_id,
          opcode: 0,
          args: smallvec![Argument::Object(source.map(|o| o.as_ref().id()).unwrap_or(0)),],
        },
        Request::Destroy => Message {
          sender_id: sender_id,
          opcode: 1,
    ...
    unsafe fn from_raw_c(obj: *mut ::std::os::raw::c_void, opcode: u32, args: *const wl_argument) -> Result<Event, ()> {
      match opcode {
        0 => {
          ...
          Ok(Event::DataOffer {
            id: Main::<super::zwlr_data_control_offer_v1::ZwlrDataControlOfferV1>::from_c_ptr(_args[0].o as *mut _),
          })
        }
        1 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::Selection {
            id: if _args[0].o.is_null() {
              ...
              Some(
                Proxy::<super::zwlr_data_control_offer_v1::ZwlrDataControlOfferV1>::from_c_ptr(_args[0].o as *mut _)
                  .into(),
              )
            },
          })
  ...
  impl ZwlrDataControlDeviceV1 {
    #[doc = "copy data to the selection\n\nThis request asks the compositor to set the selection to the data from\nthe source on behalf of the client.\n\nThe given source may not be used in any further set_selection or\nset_primary_selection requests. Attempting to use a previously used\nsource is a protocol error.\n\nTo unset the selection, set the source to NULL."]
    pub fn set_selection(&self, source: Option<&super::zwlr_data_control_source_v1::ZwlrDataControlSourceV1>) -> () {
  ...
  static mut zwlr_data_control_device_v1_requests_set_selection_types: [*const wl_interface; 1] =
    [unsafe { &super::zwlr_data_control_source_v1::zwlr_data_control_source_v1_interface as *const wl_interface }];
  static mut zwlr_data_control_device_v1_requests_set_primary_selection_types: [*const wl_interface; 1] =
    [unsafe { &super::zwlr_data_control_source_v1::zwlr_data_control_source_v1_interface as *const wl_interface }];
  #[doc = r" C-representation of the messages of this interface, for interop"]
  pub static mut zwlr_data_control_device_v1_requests: [wl_message; 3] = [
    ...
    wl_message {
      ...
      types: unsafe { &zwlr_data_control_device_v1_requests_set_primary_selection_types as *const _ },
    },
  ];
  static mut zwlr_data_control_device_v1_events_data_offer_types: [*const wl_interface; 1] =
    [unsafe { &super::zwlr_data_control_offer_v1::zwlr_data_control_offer_v1_interface as *const wl_interface }];
  static mut zwlr_data_control_device_v1_events_selection_types: [*const wl_interface; 1] =
    [unsafe { &super::zwlr_data_control_offer_v1::zwlr_data_control_offer_v1_interface as *const wl_interface }];
  static mut zwlr_data_control_device_v1_events_primary_selection_types: [*const wl_interface; 1] =
    [unsafe { &super::zwlr_data_control_offer_v1::zwlr_data_control_offer_v1_interface as *const wl_interface }];
  #[doc = r" C-representation of the messages of this interface, for interop"]
  pub static mut zwlr_data_control_device_v1_events: [wl_message; 4] = [
    ...
    wl_message {
      ...
      signature: b"2?o\0" as *const u8 as *const c_char,
      types: unsafe { &zwlr_data_control_device_v1_events_primary_selection_types as *const _ },
    },
  ];
  #[doc = r" C representation of this interface, for interop"]
