...
pub mod zwlr_output_manager_v1 {
  ...
  impl super::MessageGroup for Event {
    ...
    fn child<Meta: ObjectMetadata>(opcode: u16, version: u32, meta: &Meta) -> Option<Object<Meta>> {
      match opcode {
        0 => Some(Object::from_interface::<super::zwlr_output_head_v1::ZwlrOutputHeadV1>(
          version,
          meta.child(),
        )),
        _ => None,
    ...
    unsafe fn from_raw_c(obj: *mut ::std::os::raw::c_void, opcode: u32, args: *const wl_argument) -> Result<Event, ()> {
      match opcode {
        0 => {
          ...
          Ok(Event::Head {
            head: Main::<super::zwlr_output_head_v1::ZwlrOutputHeadV1>::from_c_ptr(_args[0].o as *mut _),
          })
        }
        1 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
  ...
  static mut zwlr_output_manager_v1_requests_create_configuration_types: [*const wl_interface; 2] = [
    unsafe { &super::zwlr_output_configuration_v1::zwlr_output_configuration_v1_interface as *const wl_interface },
  ...
  pub static mut zwlr_output_manager_v1_requests: [wl_message; 2] = [
    wl_message {
      ...
      types: unsafe { &zwlr_output_manager_v1_requests_create_configuration_types as *const _ },
    },
    wl_message {
  ...
  static mut zwlr_output_manager_v1_events_head_types: [*const wl_interface; 1] =
    [unsafe { &super::zwlr_output_head_v1::zwlr_output_head_v1_interface as *const wl_interface }];
  #[doc = r" C-representation of the messages of this interface, for interop"]
...
pub mod zwlr_output_head_v1 {
  ...
  pub enum Event {
    ...
    Transform { transform: super::wl_output::Transform },
  ...
  impl super::MessageGroup for Event {
    ...
    fn child<Meta: ObjectMetadata>(opcode: u16, version: u32, meta: &Meta) -> Option<Object<Meta>> {
      match opcode {
        3 => Some(Object::from_interface::<super::zwlr_output_mode_v1::ZwlrOutputModeV1>(
          version,
          meta.child(),
        )),
        _ => None,
    ...
    unsafe fn from_raw_c(obj: *mut ::std::os::raw::c_void, opcode: u32, args: *const wl_argument) -> Result<Event, ()> {
      match opcode {
        ...
        3 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::Mode {
            mode: Main::<super::zwlr_output_mode_v1::ZwlrOutputModeV1>::from_c_ptr(_args[0].o as *mut _),
          })
        }
        4 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::Enabled { enabled: _args[0].i })
        }
        5 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::CurrentMode {
            mode: Proxy::<super::zwlr_output_mode_v1::ZwlrOutputModeV1>::from_c_ptr(_args[0].o as *mut _).into(),
          })
        }
        6 => {
          let _args = ::std::slice::from_raw_parts(args, 2);
        ...
        7 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::Transform {
            transform: super::wl_output::Transform::from_raw(_args[0].i as u32).ok_or(())?,
          })
        }
        8 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
        ...
        10 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::Make {
            make: ::std::ffi::CStr::from_ptr(_args[0].s).to_string_lossy().into_owned(),
          })
        }
        11 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::Model {
            model: ::std::ffi::CStr::from_ptr(_args[0].s).to_string_lossy().into_owned(),
          })
        }
        12 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::SerialNumber {
            serial_number: ::std::ffi::CStr::from_ptr(_args[0].s).to_string_lossy().into_owned(),
          })
        }
        _ => return Err(()),
      }
  ...
  static mut zwlr_output_head_v1_events_mode_types: [*const wl_interface; 1] =
    [unsafe { &super::zwlr_output_mode_v1::zwlr_output_mode_v1_interface as *const wl_interface }];
  static mut zwlr_output_head_v1_events_current_mode_types: [*const wl_interface; 1] =
    [unsafe { &super::zwlr_output_mode_v1::zwlr_output_mode_v1_interface as *const wl_interface }];
  #[doc = r" C-representation of the messages of this interface, for interop"]
  ...
  impl super::MessageGroup for Event {
    ...
    unsafe fn from_raw_c(obj: *mut ::std::os::raw::c_void, opcode: u32, args: *const wl_argument) -> Result<Event, ()> {
      match opcode {
        ...
        1 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::Refresh { refresh: _args[0].i })
        }
        2 => Ok(Event::Preferred),
        3 => Ok(Event::Finished),
        _ => return Err(()),
...
pub mod zwlr_output_configuration_v1 {
  ...
  static mut zwlr_output_configuration_v1_requests_enable_head_types: [*const wl_interface; 2] = [
    unsafe {
      &super::zwlr_output_configuration_head_v1::zwlr_output_configuration_head_v1_interface as *const wl_interface
    },
    unsafe { &super::zwlr_output_head_v1::zwlr_output_head_v1_interface as *const wl_interface },
  ];
...
pub mod zwlr_output_configuration_head_v1 {
  ...
  pub enum Request {
    ...
    SetCustomMode { width: i32, height: i32, refresh: i32 },
    #[doc = "set the position\n\nThis request sets the head's position in the global compositor space."]
    SetPosition { x: i32, y: i32 },
    #[doc = "set the transform\n\nThis request sets the head's transform."]
    SetTransform { transform: super::wl_output::Transform },
  ...
  impl super::MessageGroup for Request {
    ...
    fn into_raw(self, sender_id: u32) -> Message {
      match self {
        ...
        Request::SetCustomMode { width, height, refresh } => Message {
          sender_id: sender_id,
          opcode: 1,
          args: smallvec![Argument::Int(width), Argument::Int(height), Argument::Int(refresh),],
        },
  ...
  impl ZwlrOutputConfigurationHeadV1 {
    ...
    pub fn set_transform(&self, transform: super::wl_output::Transform) -> () {
      let msg = Request::SetTransform { transform: transform };
      self.0.send::<AnonymousObject>(msg, None);
    }
    #[doc = "set the scale\n\nThis request sets the head's scale."]
  ...
  pub static mut zwlr_output_configuration_head_v1_requests: [wl_message; 5] = [
    wl_message {
      ...
      signature: b"o\0" as *const u8 as *const c_char,
      types: unsafe { &zwlr_output_configuration_head_v1_requests_set_mode_types as *const _ },
    },
    wl_message {
