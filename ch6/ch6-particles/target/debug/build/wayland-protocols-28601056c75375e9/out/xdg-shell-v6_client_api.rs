...
pub mod zxdg_shell_v6 {
  ...
  impl super::MessageGroup for Request {
    ...
    fn child<Meta: ObjectMetadata>(opcode: u16, version: u32, meta: &Meta) -> Option<Object<Meta>> {
      match opcode {
        1 => Some(Object::from_interface::<super::zxdg_positioner_v6::ZxdgPositionerV6>(
          version,
          meta.child(),
        )),
        2 => Some(Object::from_interface::<super::zxdg_surface_v6::ZxdgSurfaceV6>(
          version,
          meta.child(),
        )),
        _ => None,
...
pub mod zxdg_surface_v6 {
  ...
  impl super::MessageGroup for Request {
    ...
    fn child<Meta: ObjectMetadata>(opcode: u16, version: u32, meta: &Meta) -> Option<Object<Meta>> {
      match opcode {
        1 => Some(Object::from_interface::<super::zxdg_toplevel_v6::ZxdgToplevelV6>(
          version,
          meta.child(),
        )),
