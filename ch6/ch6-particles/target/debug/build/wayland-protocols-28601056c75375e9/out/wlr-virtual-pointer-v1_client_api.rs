...
pub mod zwlr_virtual_pointer_v1 {
  ...
  pub enum Request {
    ...
    AxisSource { axis_source: super::wl_pointer::AxisSource },
    #[doc = "axis stop event\n\nStop notification for scroll and other axes."]
    AxisStop { time: u32, axis: super::wl_pointer::Axis },
  ...
  impl super::MessageGroup for Request {
    ...
    fn into_raw(self, sender_id: u32) -> Message {
      match self {
        ...
        Request::Button { time, button, state } => Message {
          sender_id: sender_id,
          opcode: 2,
          args: smallvec![
            Argument::Uint(time),
  ...
  impl ZwlrVirtualPointerV1 {
    ...
    pub fn axis_stop(&self, time: u32, axis: super::wl_pointer::Axis) -> () {
      let msg = Request::AxisStop { time: time, axis: axis };
      self.0.send::<AnonymousObject>(msg, None);
    }
    #[doc = "axis click event\n\nDiscrete step information for scroll and other axes.\n\nThis event allows the client to extend data normally sent using the axis\nevent with discrete value."]
    pub fn axis_discrete(&self, time: u32, axis: super::wl_pointer::Axis, value: f64, discrete: i32) -> () {
...
pub mod zwlr_virtual_pointer_manager_v1 {
  ...
  pub enum Request {
    ...
    CreateVirtualPointer { seat: Option<super::wl_seat::WlSeat> },
  ...
  static mut zwlr_virtual_pointer_manager_v1_requests_create_virtual_pointer_types: [*const wl_interface; 2] = [
    unsafe { &super::wl_seat::wl_seat_interface as *const wl_interface },
    unsafe { &super::zwlr_virtual_pointer_v1::zwlr_virtual_pointer_v1_interface as *const wl_interface },
  ];
  static mut zwlr_virtual_pointer_manager_v1_requests_create_virtual_pointer_with_output_types: [*const wl_interface;
    3] = [
    unsafe { &super::wl_seat::wl_seat_interface as *const wl_interface },
  ...
  pub static mut zwlr_virtual_pointer_manager_v1_requests: [wl_message; 3] = [
    wl_message {
      ...
      types: unsafe { &zwlr_virtual_pointer_manager_v1_requests_create_virtual_pointer_types as *const _ },
    },
    wl_message {
      name: b"destroy\0" as *const u8 as *const c_char,
      signature: b"\0" as *const u8 as *const c_char,
    ...
    wl_message {
      ...
      types: unsafe { &zwlr_virtual_pointer_manager_v1_requests_create_virtual_pointer_with_output_types as *const _ },
    },
  ];
  #[doc = r" C representation of this interface, for interop"]
