...
pub mod zwp_tablet_manager_v2 {
  ...
  impl super::MessageGroup for Request {
    ...
    fn child<Meta: ObjectMetadata>(opcode: u16, version: u32, meta: &Meta) -> Option<Object<Meta>> {
      match opcode {
        0 => Some(Object::from_interface::<super::zwp_tablet_seat_v2::ZwpTabletSeatV2>(
          version,
          meta.child(),
        )),
        _ => None,
  ...
  impl ZwpTabletManagerV2 {
    #[doc = "get the tablet seat\n\nGet the wp_tablet_seat object for the given seat. This object\nprovides access to all graphics tablets in this seat."]
    pub fn get_tablet_seat(&self, seat: &super::wl_seat::WlSeat) -> Main<super::zwp_tablet_seat_v2::ZwpTabletSeatV2> {
...
pub mod zwp_tablet_seat_v2 {
  ...
  impl super::MessageGroup for Event {
    ...
    fn child<Meta: ObjectMetadata>(opcode: u16, version: u32, meta: &Meta) -> Option<Object<Meta>> {
      match opcode {
        ...
        1 => Some(Object::from_interface::<super::zwp_tablet_tool_v2::ZwpTabletToolV2>(
          version,
          meta.child(),
        )),
        2 => Some(Object::from_interface::<super::zwp_tablet_pad_v2::ZwpTabletPadV2>(
          version,
          meta.child(),
        )),
        _ => None,
    ...
    unsafe fn from_raw_c(obj: *mut ::std::os::raw::c_void, opcode: u32, args: *const wl_argument) -> Result<Event, ()> {
      match opcode {
        0 => {
          ...
          Ok(Event::TabletAdded {
            id: Main::<super::zwp_tablet_v2::ZwpTabletV2>::from_c_ptr(_args[0].o as *mut _),
          })
        }
        1 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::ToolAdded {
            id: Main::<super::zwp_tablet_tool_v2::ZwpTabletToolV2>::from_c_ptr(_args[0].o as *mut _),
          })
        }
        2 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::PadAdded {
            id: Main::<super::zwp_tablet_pad_v2::ZwpTabletPadV2>::from_c_ptr(_args[0].o as *mut _),
          })
        }
        _ => return Err(()),
      }
  ...
  static mut zwp_tablet_seat_v2_events_tool_added_types: [*const wl_interface; 1] =
    [unsafe { &super::zwp_tablet_tool_v2::zwp_tablet_tool_v2_interface as *const wl_interface }];
  static mut zwp_tablet_seat_v2_events_pad_added_types: [*const wl_interface; 1] =
    [unsafe { &super::zwp_tablet_pad_v2::zwp_tablet_pad_v2_interface as *const wl_interface }];
  #[doc = r" C-representation of the messages of this interface, for interop"]
    ...
    unsafe fn from_raw_c(obj: *mut ::std::os::raw::c_void, opcode: u32, args: *const wl_argument) -> Result<Event, ()> {
      match opcode {
        ...
        6 => {
          ...
          Ok(Event::ProximityIn {
            serial: _args[0].u,
            tablet: Proxy::<super::zwp_tablet_v2::ZwpTabletV2>::from_c_ptr(_args[1].o as *mut _).into(),
        ...
        11 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::Pressure { pressure: _args[0].u })
        }
        12 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::Distance { distance: _args[0].u })
        }
        13 => {
          let _args = ::std::slice::from_raw_parts(args, 2);
          Ok(Event::Tilt {
        ...
        15 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::Slider { position: _args[0].i })
        }
        16 => {
          let _args = ::std::slice::from_raw_parts(args, 2);
          Ok(Event::Wheel {
  ...
  impl super::MessageGroup for Event {
    ...
    unsafe fn from_raw_c(obj: *mut ::std::os::raw::c_void, opcode: u32, args: *const wl_argument) -> Result<Event, ()> {
      match opcode {
        ...
        1 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::Position { position: _args[0].u })
        }
        2 => Ok(Event::Stop),
        3 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
...
pub mod zwp_tablet_pad_group_v2 {
    ...
    unsafe fn from_raw_c(obj: *mut ::std::os::raw::c_void, opcode: u32, args: *const wl_argument) -> Result<Event, ()> {
      match opcode {
        ...
        1 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::Ring {
            ring: Main::<super::zwp_tablet_pad_ring_v2::ZwpTabletPadRingV2>::from_c_ptr(_args[0].o as *mut _),
          })
        }
        2 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::Strip {
            strip: Main::<super::zwp_tablet_pad_strip_v2::ZwpTabletPadStripV2>::from_c_ptr(_args[0].o as *mut _),
          })
        }
        3 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
  ...
  static mut zwp_tablet_pad_group_v2_events_ring_types: [*const wl_interface; 1] =
    [unsafe { &super::zwp_tablet_pad_ring_v2::zwp_tablet_pad_ring_v2_interface as *const wl_interface }];
  static mut zwp_tablet_pad_group_v2_events_strip_types: [*const wl_interface; 1] =
    [unsafe { &super::zwp_tablet_pad_strip_v2::zwp_tablet_pad_strip_v2_interface as *const wl_interface }];
  #[doc = r" C-representation of the messages of this interface, for interop"]
...
pub mod zwp_tablet_pad_v2 {
    ...
    unsafe fn from_raw_c(obj: *mut ::std::os::raw::c_void, opcode: u32, args: *const wl_argument) -> Result<Event, ()> {
      match opcode {
        0 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::Group {
            pad_group: Main::<super::zwp_tablet_pad_group_v2::ZwpTabletPadGroupV2>::from_c_ptr(_args[0].o as *mut _),
          })
        }
        1 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
        ...
        2 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::Buttons { buttons: _args[0].u })
        }
        3 => Ok(Event::Done),
        4 => {
          let _args = ::std::slice::from_raw_parts(args, 3);
  ...
  static mut zwp_tablet_pad_v2_events_group_types: [*const wl_interface; 1] =
    [unsafe { &super::zwp_tablet_pad_group_v2::zwp_tablet_pad_group_v2_interface as *const wl_interface }];
