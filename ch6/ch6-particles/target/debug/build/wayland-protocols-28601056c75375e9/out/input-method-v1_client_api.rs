    ...
    fn into_raw(self, sender_id: u32) -> Message {
      match self {
        ...
        Request::PreeditStyling { index, length, style } => Message {
          sender_id: sender_id,
          opcode: 3,
          args: smallvec![Argument::Uint(index), Argument::Uint(length), Argument::Uint(style),],
        },
...
pub mod zwp_input_method_v1 {
    ...
    unsafe fn from_raw_c(obj: *mut ::std::os::raw::c_void, opcode: u32, args: *const wl_argument) -> Result<Event, ()> {
      match opcode {
        0 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::Activate {
            id: Main::<super::zwp_input_method_context_v1::ZwpInputMethodContextV1>::from_c_ptr(_args[0].o as *mut _),
          })
        }
        1 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::Deactivate {
            context: Proxy::<super::zwp_input_method_context_v1::ZwpInputMethodContextV1>::from_c_ptr(
              _args[0].o as *mut _,
            )
            .into(),
          })
  ...
  static mut zwp_input_method_v1_events_activate_types: [*const wl_interface; 1] =
    [unsafe { &super::zwp_input_method_context_v1::zwp_input_method_context_v1_interface as *const wl_interface }];
...
pub mod zwp_input_panel_v1 {
  ...
  pub enum Request {
    #[doc = ""]
    GetInputPanelSurface { surface: super::wl_surface::WlSurface },
  }
  impl super::MessageGroup for Request {
  ...
  static mut zwp_input_panel_v1_requests_get_input_panel_surface_types: [*const wl_interface; 2] = [
    unsafe { &super::zwp_input_panel_surface_v1::zwp_input_panel_surface_v1_interface as *const wl_interface },
    ...
    fn into_raw(self, sender_id: u32) -> Message {
      match self {
        Request::SetToplevel { output, position } => Message {
          sender_id: sender_id,
          opcode: 0,
          args: smallvec![Argument::Object(output.as_ref().id()), Argument::Uint(position),],
        },
