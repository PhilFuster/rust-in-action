...
pub mod zwp_tablet_manager_v1 {
  ...
  impl super::MessageGroup for Request {
    ...
    fn child<Meta: ObjectMetadata>(opcode: u16, version: u32, meta: &Meta) -> Option<Object<Meta>> {
      match opcode {
        0 => Some(Object::from_interface::<super::zwp_tablet_seat_v1::ZwpTabletSeatV1>(
          version,
          meta.child(),
        )),
        _ => None,
  ...
  impl ZwpTabletManagerV1 {
    #[doc = "get the tablet seat\n\nGet the wp_tablet_seat object for the given seat. This object\nprovides access to all graphics tablets in this seat."]
    pub fn get_tablet_seat(&self, seat: &super::wl_seat::WlSeat) -> Main<super::zwp_tablet_seat_v1::ZwpTabletSeatV1> {
...
pub mod zwp_tablet_seat_v1 {
  ...
  impl super::MessageGroup for Event {
    ...
    fn child<Meta: ObjectMetadata>(opcode: u16, version: u32, meta: &Meta) -> Option<Object<Meta>> {
      match opcode {
        ...
        1 => Some(Object::from_interface::<super::zwp_tablet_tool_v1::ZwpTabletToolV1>(
          version,
          meta.child(),
        )),
        _ => None,
    ...
    unsafe fn from_raw_c(obj: *mut ::std::os::raw::c_void, opcode: u32, args: *const wl_argument) -> Result<Event, ()> {
      match opcode {
        0 => {
          ...
          Ok(Event::TabletAdded {
            id: Main::<super::zwp_tablet_v1::ZwpTabletV1>::from_c_ptr(_args[0].o as *mut _),
          })
        }
        1 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::ToolAdded {
            id: Main::<super::zwp_tablet_tool_v1::ZwpTabletToolV1>::from_c_ptr(_args[0].o as *mut _),
          })
        }
        _ => return Err(()),
      }
  ...
  static mut zwp_tablet_seat_v1_events_tool_added_types: [*const wl_interface; 1] =
    [unsafe { &super::zwp_tablet_tool_v1::zwp_tablet_tool_v1_interface as *const wl_interface }];
  #[doc = r" C-representation of the messages of this interface, for interop"]
    ...
    unsafe fn from_raw_c(obj: *mut ::std::os::raw::c_void, opcode: u32, args: *const wl_argument) -> Result<Event, ()> {
      match opcode {
        ...
        6 => {
          ...
          Ok(Event::ProximityIn {
            serial: _args[0].u,
            tablet: Proxy::<super::zwp_tablet_v1::ZwpTabletV1>::from_c_ptr(_args[1].o as *mut _).into(),
        ...
        14 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::Rotation { degrees: _args[0].i })
        }
        15 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
