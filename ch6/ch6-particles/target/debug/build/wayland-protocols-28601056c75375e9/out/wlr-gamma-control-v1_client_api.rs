...
pub mod zwlr_gamma_control_manager_v1 {
  ...
  impl ZwlrGammaControlManagerV1 {
    ...
    pub fn get_gamma_control(
      ...
      let msg = Request::GetGammaControl { output: output.clone() };
  ...
  static mut zwlr_gamma_control_manager_v1_requests_get_gamma_control_types: [*const wl_interface; 2] = [
    unsafe { &super::zwlr_gamma_control_v1::zwlr_gamma_control_v1_interface as *const wl_interface },
  ...
  pub static mut zwlr_gamma_control_manager_v1_requests: [wl_message; 2] = [
    wl_message {
      ...
      types: unsafe { &zwlr_gamma_control_manager_v1_requests_get_gamma_control_types as *const _ },
    },
    wl_message {
