...
pub mod zwp_relative_pointer_manager_v1 {
  ...
  pub enum Request {
    ...
    GetRelativePointer { pointer: super::wl_pointer::WlPointer },
  }
  ...
  static mut zwp_relative_pointer_manager_v1_requests_get_relative_pointer_types: [*const wl_interface; 2] = [
    unsafe { &super::zwp_relative_pointer_v1::zwp_relative_pointer_v1_interface as *const wl_interface },
  ...
  pub static mut zwp_relative_pointer_manager_v1_requests: [wl_message; 2] = [
    ...
    wl_message {
      ...
      types: unsafe { &zwp_relative_pointer_manager_v1_requests_get_relative_pointer_types as *const _ },
    },
  ];
