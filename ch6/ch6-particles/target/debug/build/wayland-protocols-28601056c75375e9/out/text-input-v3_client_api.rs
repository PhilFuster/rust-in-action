...
pub mod zwp_text_input_v3 {
  ...
  pub enum Request {
    ...
    SetSurroundingText { text: String, cursor: i32, anchor: i32 },
    ...
    SetContentType { hint: ContentHint, purpose: ContentPurpose },
    ...
    fn into_raw(self, sender_id: u32) -> Message {
      match self {
        ...
        Request::SetContentType { hint, purpose } => Message {
          sender_id: sender_id,
          opcode: 5,
          args: smallvec![Argument::Uint(hint.to_raw()), Argument::Uint(purpose.to_raw()),],
        },
  ...
  pub enum Event {
    ...
    Enter { surface: super::wl_surface::WlSurface },
    #[doc = "leave event\n\nNotification that this seat's text-input focus is no longer on a\ncertain surface. The client should reset any preedit string previously\nset.\n\nThe leave notification clears the current surface. It is sent before\nthe enter notification for the new focus.\n\nWhen the seat has the keyboard capability the text-input focus follows\nthe keyboard focus."]
    Leave { surface: super::wl_surface::WlSurface },
    ...
    unsafe fn from_raw_c(obj: *mut ::std::os::raw::c_void, opcode: u32, args: *const wl_argument) -> Result<Event, ()> {
      match opcode {
        0 => {
          ...
          Ok(Event::Enter {
            surface: Proxy::<super::wl_surface::WlSurface>::from_c_ptr(_args[0].o as *mut _).into(),
          })
        }
        1 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
...
pub mod zwp_text_input_manager_v3 {
  ...
  impl super::MessageGroup for Request {
    ...
    fn child<Meta: ObjectMetadata>(opcode: u16, version: u32, meta: &Meta) -> Option<Object<Meta>> {
      match opcode {
        1 => Some(Object::from_interface::<super::zwp_text_input_v3::ZwpTextInputV3>(
          version,
          meta.child(),
        )),
        _ => None,
  ...
  impl ZwpTextInputManagerV3 {
    ...
    #[doc = "create a new text input object\n\nCreates a new text-input object for a given seat."]
    pub fn get_text_input(&self, seat: &super::wl_seat::WlSeat) -> Main<super::zwp_text_input_v3::ZwpTextInputV3> {
