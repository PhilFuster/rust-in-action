...
pub mod wl_display {
  ...
  use super::{
    smallvec, types_null, AnonymousObject, Argument, ArgumentType, Interface, Main, Message, MessageDesc, MessageGroup,
    Object, ObjectMetadata, Proxy, NULLPTR,
  };
    ...
    unsafe fn from_raw_c(obj: *mut ::std::os::raw::c_void, opcode: u32, args: *const wl_argument) -> Result<Event, ()> {
      match opcode {
        0 => {
          ...
          Ok(Event::Error {
            object_id: Proxy::<AnonymousObject>::from_c_ptr(_args[0].o as *mut _).into(),
            code: _args[1].u,
...
pub mod wl_registry {
  ...
  impl WlRegistry {
    #[doc = "bind an object to the display\n\nBinds a new, client-created object to the server using the\nspecified name as the identifier."]
    pub fn bind<T: Interface + From<Proxy<T>> + AsRef<Proxy<T>>>(&self, version: u32, name: u32) -> Main<T> {
...
pub mod wl_shm {
  ...
  pub enum Request {
    ...
    CreatePool { fd: ::std::os::unix::io::RawFd, size: i32 },
  }
  impl super::MessageGroup for Request {
    const MESSAGES: &'static [super::MessageDesc] = &[super::MessageDesc {
      name: "create_pool",
  ...
  impl WlShm {
    #[doc = "create a shm pool\n\nCreate a new wl_shm_pool object.\n\nThe pool can be used to create shared memory based buffer\nobjects.  The server will mmap size bytes of the passed file\ndescriptor, to use as backing memory for the pool."]
    pub fn create_pool(&self, fd: ::std::os::unix::io::RawFd, size: i32) -> Main<super::wl_shm_pool::WlShmPool> {
      ...
      match self {
        Request::Accept { serial, mime_type } => Message {
          ...
          args: smallvec![
            ...
            Argument::Str(Box::new(unsafe {
              ::std::ffi::CString::from_vec_unchecked(mime_type.map(Into::into).unwrap_or_else(Vec::new))
            })),
          ],
        },
        ...
        Request::SetActions {
          ...
          opcode: 4,
          args: smallvec![
            Argument::Uint(dnd_actions.to_raw()),
            Argument::Uint(preferred_action.to_raw()),
          ],
        },
      }
    }
      ...
      F: FnOnce(u32, &mut [wl_argument]) -> T,
    {
      match self {
        ...
        Request::SetActions {
          ...
          let mut _args_array: [wl_argument; 2] = unsafe { ::std::mem::zeroed() };
          _args_array[0].u = dnd_actions.to_raw();
          _args_array[1].u = preferred_action.to_raw();
          f(4, &mut _args_array)
        }
      }
    }
      ...
      match msg.opcode {
        ...
        1 => {
          ...
          Ok(Event::SourceActions {
            source_actions: {
              if let Some(Argument::Uint(val)) = args.next() {
                super::wl_data_device_manager::DndAction::from_raw(val).ok_or(())?
              } else {
                return Err(());
              }
            },
    ...
    unsafe fn from_raw_c(obj: *mut ::std::os::raw::c_void, opcode: u32, args: *const wl_argument) -> Result<Event, ()> {
      match opcode {
        ...
        1 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::SourceActions {
            source_actions: super::wl_data_device_manager::DndAction::from_raw(_args[0].u).ok_or(())?,
          })
        }
        2 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::Action {
            dnd_action: super::wl_data_device_manager::DndAction::from_raw(_args[0].u).ok_or(())?,
          })
        }
        _ => return Err(()),
      }
...
pub mod wl_data_source {
    ...
    fn into_raw(self, sender_id: u32) -> Message {
      match self {
        ...
        Request::SetActions { dnd_actions } => Message {
          sender_id: sender_id,
          opcode: 2,
          args: smallvec![Argument::Uint(dnd_actions.to_raw()),],
        },
      }
    }
    unsafe fn from_raw_c(
        ...
        0 => {
          ...
          Ok(Event::Target {
            mime_type: if _args[0].s.is_null() {
              ...
              Some(::std::ffi::CStr::from_ptr(_args[0].s).to_string_lossy().into_owned())
            },
          })
        }
        1 => {
  ...
  impl WlDataSource {
    ...
    pub fn offer(&self, mime_type: String) -> () {
      let msg = Request::Offer { mime_type: mime_type };
      self.0.send::<AnonymousObject>(msg, None);
    }
    #[doc = "destroy the data source\n\nDestroy the data source.\n\nThis is a destructor, you cannot send requests to this object any longer once this method is called."]
    pub fn destroy(&self) -> () {
    ...
    #[doc = "set the available drag-and-drop actions\n\nSets the actions that the source side client supports for this\noperation. This request may trigger wl_data_source.action and\nwl_data_offer.action events if the compositor needs to change the\nselected action.\n\nThe dnd_actions argument must contain only values expressed in the\nwl_data_device_manager.dnd_actions enum, otherwise it will result\nin a protocol error.\n\nThis request must be made once only, and can only be made on sources\nused in drag-and-drop, so it must be performed before\nwl_data_device.start_drag. Attempting to use the source other than\nfor drag-and-drop will raise a protocol error.\n\nOnly available since version 3 of the interface."]
    pub fn set_actions(&self, dnd_actions: super::wl_data_device_manager::DndAction) -> () {
      let msg = Request::SetActions {
        dnd_actions: dnd_actions,
      };
      self.0.send::<AnonymousObject>(msg, None);
...
pub mod wl_data_device {
    ...
    unsafe fn from_raw_c(obj: *mut ::std::os::raw::c_void, opcode: u32, args: *const wl_argument) -> Result<Event, ()> {
      match opcode {
        0 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::DataOffer {
            id: Main::<super::wl_data_offer::WlDataOffer>::from_c_ptr(_args[0].o as *mut _),
          })
        }
        1 => {
          ...
          Ok(Event::Enter {
            serial: _args[0].u,
            surface: Proxy::<super::wl_surface::WlSurface>::from_c_ptr(_args[1].o as *mut _).into(),
            x: (_args[2].f as f64) / 256.,
            y: (_args[3].f as f64) / 256.,
            id: if _args[4].o.is_null() {
              None
            } else {
              Some(Proxy::<super::wl_data_offer::WlDataOffer>::from_c_ptr(_args[4].o as *mut _).into())
            },
          })
        }
        2 => Ok(Event::Leave),
        ...
        5 => {
          ...
          Ok(Event::Selection {
            id: if _args[0].o.is_null() {
              ...
              Some(Proxy::<super::wl_data_offer::WlDataOffer>::from_c_ptr(_args[0].o as *mut _).into())
            },
          })
        }
        _ => return Err(()),
  ...
  impl WlDataDevice {
    ...
    #[doc = "copy data to the selection\n\nThis request asks the compositor to set the selection\nto the data from the source on behalf of the client.\n\nTo unset the selection, set the source to NULL."]
    pub fn set_selection(&self, source: Option<&super::wl_data_source::WlDataSource>, serial: u32) -> () {
...
pub mod wl_data_device_manager {
  ...
  impl super::MessageGroup for Request {
    ...
    fn child<Meta: ObjectMetadata>(opcode: u16, version: u32, meta: &Meta) -> Option<Object<Meta>> {
      match opcode {
        0 => Some(Object::from_interface::<super::wl_data_source::WlDataSource>(
          version,
          meta.child(),
        )),
        1 => Some(Object::from_interface::<super::wl_data_device::WlDataDevice>(
          version,
          meta.child(),
        )),
        _ => None,
  ...
  impl WlDataDeviceManager {
    ...
    #[doc = "create a new data device\n\nCreate a new data device for a given seat."]
    pub fn get_data_device(&self, seat: &super::wl_seat::WlSeat) -> Main<super::wl_data_device::WlDataDevice> {
...
pub mod wl_shell {
  ...
  pub enum Request {
    ...
    GetShellSurface { surface: super::wl_surface::WlSurface },
  }
  impl super::MessageGroup for Request {
    const MESSAGES: &'static [super::MessageDesc] = &[super::MessageDesc {
    ...
    fn child<Meta: ObjectMetadata>(opcode: u16, version: u32, meta: &Meta) -> Option<Object<Meta>> {
      match opcode {
        0 => Some(Object::from_interface::<super::wl_shell_surface::WlShellSurface>(
          version,
          meta.child(),
        )),
        _ => None,
...
pub mod wl_shell_surface {
  ...
  pub enum Request {
    ...
    Move { seat: super::wl_seat::WlSeat, serial: u32 },
    ...
    SetMaximized { output: Option<super::wl_output::WlOutput> },
  ...
  impl super::MessageGroup for Request {
    ...
    fn into_raw(self, sender_id: u32) -> Message {
      match self {
        ...
        Request::SetTransient { parent, x, y, flags } => Message {
          sender_id: sender_id,
          opcode: 4,
          args: smallvec![
        ...
        Request::SetMaximized { output } => Message {
          sender_id: sender_id,
          opcode: 7,
          args: smallvec![Argument::Object(output.map(|o| o.as_ref().id()).unwrap_or(0)),],
        },
  ...
  static mut wl_shell_surface_requests_set_fullscreen_types: [*const wl_interface; 3] =
    [NULLPTR as *const wl_interface, NULLPTR as *const wl_interface, unsafe {
...
pub mod wl_surface {
  ...
  pub enum Request {
    ...
    SetOpaqueRegion { region: Option<super::wl_region::WlRegion> },
    ...
    SetInputRegion { region: Option<super::wl_region::WlRegion> },
  ...
  impl super::MessageGroup for Request {
    ...
    fn into_raw(self, sender_id: u32) -> Message {
      match self {
        ...
        Request::Damage { x, y, width, height } => Message {
          sender_id: sender_id,
          opcode: 2,
          args: smallvec![
            Argument::Int(x),
        ...
        Request::SetOpaqueRegion { region } => Message {
          sender_id: sender_id,
          opcode: 4,
          args: smallvec![Argument::Object(region.map(|o| o.as_ref().id()).unwrap_or(0)),],
        },
        ...
        Request::DamageBuffer { x, y, width, height } => Message {
          sender_id: sender_id,
          opcode: 9,
          args: smallvec![
            Argument::Int(x),
    ...
    unsafe fn from_raw_c(obj: *mut ::std::os::raw::c_void, opcode: u32, args: *const wl_argument) -> Result<Event, ()> {
      match opcode {
        0 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
          Ok(Event::Enter {
            output: Proxy::<super::wl_output::WlOutput>::from_c_ptr(_args[0].o as *mut _).into(),
          })
        }
        1 => {
          let _args = ::std::slice::from_raw_parts(args, 1);
  ...
  impl WlSurface {
    ...
    pub fn set_buffer_transform(&self, transform: super::wl_output::Transform) -> () {
      let msg = Request::SetBufferTransform { transform: transform };
      self.0.send::<AnonymousObject>(msg, None);
    }
    #[doc = "sets the buffer scaling factor\n\nThis request sets an optional scaling factor on how the compositor\ninterprets the contents of the buffer attached to the window.\n\nBuffer scale is double-buffered state, see wl_surface.commit.\n\nA newly created surface has its buffer scale set to 1.\n\nwl_surface.set_buffer_scale changes the pending buffer scale.\nwl_surface.commit copies the pending buffer scale to the current one.\nOtherwise, the pending and current values are never changed.\n\nThe purpose of this request is to allow clients to supply higher\nresolution buffer data for use on high resolution outputs. It is\nintended that you pick the same buffer scale as the scale of the\noutput that the surface is displayed on. This means the compositor\ncan avoid scaling when rendering the surface on that output.\n\nNote that if the scale is larger than 1, then you have to attach\na buffer that is larger (by a factor of scale in each dimension)\nthan the desired surface size.\n\nIf scale is not positive the invalid_scale protocol error is\nraised.\n\nOnly available since version 3 of the interface."]
...
pub mod wl_pointer {
  ...
  static mut wl_pointer_events_leave_types: [*const wl_interface; 2] = [NULLPTR as *const wl_interface, unsafe {
...
pub mod wl_keyboard {
  ...
  static mut wl_keyboard_events_leave_types: [*const wl_interface; 2] = [NULLPTR as *const wl_interface, unsafe {
    &super::wl_surface::wl_surface_interface as *const wl_interface
  }];
  #[doc = r" C-representation of the messages of this interface, for interop"]
      ...
      match opcode {
        0 => {
          ...
          Ok(Event::Down {
            serial: _args[0].u,
            time: _args[1].u,
            surface: Proxy::<super::wl_surface::WlSurface>::from_c_ptr(_args[2].o as *mut _).into(),
            id: _args[3].i,
  ...
  impl super::MessageGroup for Request {
    ...
    fn into_raw(self, sender_id: u32) -> Message {
      match self {
        ...
        Request::Add { x, y, width, height } => Message {
          sender_id: sender_id,
          opcode: 1,
          args: smallvec![
            Argument::Int(x),
        ...
        Request::Subtract { x, y, width, height } => Message {
          sender_id: sender_id,
          opcode: 2,
          args: smallvec![
            Argument::Int(x),
...
pub mod wl_subcompositor {
  ...
  impl super::MessageGroup for Request {
    ...
    fn child<Meta: ObjectMetadata>(opcode: u16, version: u32, meta: &Meta) -> Option<Object<Meta>> {
      match opcode {
        1 => Some(Object::from_interface::<super::wl_subsurface::WlSubsurface>(
          version,
          meta.child(),
        )),
        _ => None,
...
pub mod wl_subsurface {
  ...
  pub enum Request {
    ...
    PlaceAbove { sibling: super::wl_surface::WlSurface },
    #[doc = "restack the sub-surface\n\nThe sub-surface is placed just below the reference surface.\nSee wl_subsurface.place_above."]
    PlaceBelow { sibling: super::wl_surface::WlSurface },
